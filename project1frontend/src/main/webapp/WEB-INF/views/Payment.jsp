...
<body>
<div class="container">
<form action="<c:url value='/cart/receipt'></c:url>" method="post">
    <div class="row">
        <div class="col-xs-12 col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                    <h3>Total Amount to Pay : </h3>${total_Amount+ (total_Amount/10)}/-<br>
                ...
                <div class="panel-body">
                    <form role="form" action="<c:url value='/cart/receipt'></c:url>" method="post" >
                        <div class="row">
                            <div class="col-xs-12">
                ...
                <div class="panel-footer">
                    <div class="row">
                        ...
                        <input type="submit" value="Pay" class="btn btn-warning btn-lg btn-block">    
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
            <div id="pay-invoice" class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="<c:url value='/cart/receipt'></c:url>" method="post" novalidate="novalidate" class="needs-validation">
                        ...
                        <div class="form-group">
                            ...
                            <input id="cc-payment" name="cc-payment" type="text" class="form-control" aria-required="true" aria-invalid="false" required value="${total_Amount}">
                            <span class="invalid-feedback">Payment Amount</span>
                        </div>
