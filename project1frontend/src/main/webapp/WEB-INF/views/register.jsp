...
$(document).ready(function(){
	$('#form').validate({
		...
		messages:{
			customer:{required:"Firstname is mandatory"},
			mobile:{required:"Phonenumber is required"},
			email:{required:"Email is required",email:"Please enter valid email address"}
		}
	})
})
</script>
...
<div class="col-md-4 col-md-offset-4" id="login">
						<section id="inner-wrapper" class="login">
							<article>
								<form action="<c:url value='/all/registercustomer'></c:url>" method="post">
								
								<div class="form-group">
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-key"> </i></span>
											<input type="text" class="form-control" name="customer" id="customer" placeholder="Enter your Name">
										</div>
