...
<span style="color:red"><h2><b>${error }</b></h2></span><br>
<span style="color:black"><h2><b>${msg }</b></h2></span><br>
<%-- <h2><b>${msg }</b></h2><br> --%>
...
<b>Login Page</b>
<c:url value="/j_spring_security_check" var="url"></c:url>
<form class="dropdown-menu p-4" method="post" action="${url }">
  <div class="form-group">
<input class="form-control" type="text" name="j_username" placeholder="User Name"></div>

  <div class="form-group">
<input class="form-control" type="text" name="j_password" placeholder="Password"></div>
...
<!--       <img src="WEB-INF/resources/images/gro.png" id="icon" alt="User Icon" /> -->
    </div>
