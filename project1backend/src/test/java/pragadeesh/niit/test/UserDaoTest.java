...
class UserDaoTest {
		...
		public void registerUserTest()
		{
			...
			user.setUsername("Pragadeesh");
			user.setPassword("PK12345");
			user.setCustomerName("pragadeesh");
			user.setRole("Admin");
			user.setEnable(true);
		...
		{
			UserDetails user = userDao.getUser("pragadeesh");
		    ((UserDetail) user).setPassword("PK12345");
